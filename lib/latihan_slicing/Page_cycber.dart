...
class PageCyber extends StatefulWidget {
  const PageCyber({Key? key}) : super(key: key);

  @override
  State<PageCyber> createState() => _PageSearchState();
}

class _PageSearchState extends State<PageCyber> {
